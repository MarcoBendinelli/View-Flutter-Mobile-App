...
part of 'following_post_state.dart';
...
/// @nodoc
mixin _$FollowingPostState {
  FollowingPostStatus get status => throw _privateConstructorUsedError;
  List<ViewPost> get posts => throw _privateConstructorUsedError;
  bool get hasMoreData => throw _privateConstructorUsedError;

  @JsonKey(ignore: true)
  $FollowingPostStateCopyWith<FollowingPostState> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $FollowingPostStateCopyWith<$Res> {
  factory $FollowingPostStateCopyWith(
          FollowingPostState value, $Res Function(FollowingPostState) then) =
      _$FollowingPostStateCopyWithImpl<$Res, FollowingPostState>;
  @useResult
  $Res call(
      {FollowingPostStatus status, List<ViewPost> posts, bool hasMoreData});
}

/// @nodoc
class _$FollowingPostStateCopyWithImpl<$Res, $Val extends FollowingPostState>
    implements $FollowingPostStateCopyWith<$Res> {
  _$FollowingPostStateCopyWithImpl(this._value, this._then);
...
class __$$PostStateImplCopyWithImpl<$Res>
    extends _$FollowingPostStateCopyWithImpl<$Res, _$PostStateImpl>
...
class _$PostStateImpl with DiagnosticableTreeMixin implements _PostState {
  ...
  @override
  final FollowingPostStatus status;
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'FollowingPostState(status: $status, posts: $posts, hasMoreData: $hasMoreData)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ..add(DiagnosticsProperty('type', 'FollowingPostState'))
...
abstract class _PostState implements FollowingPostState {
  factory _PostState(
      {required final FollowingPostStatus status,
      required final List<ViewPost> posts,
      required final bool hasMoreData}) = _$PostStateImpl;

  @override
  FollowingPostStatus get status;
  @override
  List<ViewPost> get posts;
  @override
